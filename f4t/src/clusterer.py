...
def StringToNumLabels(data, l):
	for col in l:
		v = data[col].unique()
		#Alex -  I changed basestring -> str for python 3.5..
...
def Cluster(data_csv, l, k_min, k_max):
	...
	# Changed this path to align with webapp filesystem
	...
	# No point in running this I don't think...
	...
	Z = Z.reshape(xx.shape)
	 ...
	 # We don't need to plot for our web app...use Bokeh for this
	# plt.figure(1)
	# plt.clf()
